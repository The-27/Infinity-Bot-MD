...
import { infinityJadiBot } from './plugins/jadibot-serbot.js';
...
say(`Developed By • the_black•OFC`, {
font: 'console',
align: 'center',
colors: ['blueBright']
})
...
if (connection == 'open') {
console.log(chalk.bold.green('\n❀ infinity-Bot Conectado con éxito ❀'))
}
...
infinityJadiBot({pathInfinityJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
